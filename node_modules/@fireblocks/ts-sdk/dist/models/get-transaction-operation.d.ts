 ...
 * @enum {string}
 */
export declare const GetTransactionOperation: {
    ...
    readonly EnableAsset: "ENABLE_ASSET";
    readonly Stake: "STAKE";
    readonly Unstake: "UNSTAKE";
    readonly Withdraw: "WITHDRAW";
    readonly RedeemFromCompound: "REDEEM_FROM_COMPOUND";
    readonly SupplyToCompound: "SUPPLY_TO_COMPOUND";
};
