...
var UsersApi = /** @class */ (function (_super) {
    ...
    UsersApi.prototype.getUsers = function () {
        var _this = this;
        return (0, exports.UsersApiFp)(this.configuration).getUsers().then(function (request) { return request(_this.axios, _this.basePath); }).then(fireblocksResponse_1.convertToFireblocksResponse);
    };
    return UsersApi;
}(base_1.BaseAPI));
